            ...
            <div class="container-fluid">
              <div class="collapse navbar-collapse" id="subnav">
                <ul class="nav navbar-nav ">
                  <li class="active"><a href="TimeLine"><i class="fa fa-fw icon-ship-wheel"></i> ${uiLabelMap.TimeLine}</a></li>
          ...
          <div class="container-fluid">
			...
			<div class="panel panel-default">
              <div class="panel-heading panel-heading-gray">
                <i class="fa fa-search"></i> ${uiLabelMap.MSRelationshipcenter}
              </div>
      					...
      					<div class='span12'>
      						...
      						<div class='span4'>
      							<div class='row-fluid margin-top10'>
      								...
      								<div class='span7'><input type='text' style="width: 164px;height: 29px;" id="txtFirstName" /></div>
      							</div>
      							<div class='row-fluid margin-top10'>
